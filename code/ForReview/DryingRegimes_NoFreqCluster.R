#####################################################################
##
## Script name: DryingRegimes_NoFreqCLuster.R
##
## Author: Adam N. Price
##
...
############################# Description ##########################
##
## Cluster analysis of drying events using peak2zero,drying_rate,drying duration
##   and peak quantile
##
############################# Packages #############################
library(NbClust)
...
# Loop through this analysis a number of times to determine the optimal number of clusters
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Other popular clustering indecies (optional)
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
write.csv(df,"data/kmeans_NoFreq.csv")
