...
de_winter = ggplot(data=winter, aes(x = n_event_mean,y=Aggregated_region, group=paste(Aggregated_region,Class), fill=Aggregated_region,linetype=Class)) + 
  plot_lay()

de_spring = ggplot(data=spring, aes(x = n_event_mean,y=Aggregated_region, group=paste(Aggregated_region,Class), fill=Aggregated_region,linetype=Class)) +  
  plot_lay()


de_summer = ggplot(data=summer, aes(x = n_event_mean,y=Aggregated_region, group=paste(Aggregated_region,Class), fill=Aggregated_region,linetype=Class)) +  
  plot_lay()


de_fall = ggplot(data=fall, aes(x = n_event_mean,y=Aggregated_region, group=paste(Aggregated_region,Class), fill=Aggregated_region,linetype=Class)) + 
  plot_lay()


de_all = ggplot(data=all_season, aes(x = n_event_mean,y=Aggregated_region, group=paste(Aggregated_region,Class), fill=Aggregated_region,linetype=Class)) + 
  plot_lay()
...
p2z_winter = ggplot(data=winter, aes(x = peak2zero_mean,y=Aggregated_region, group=paste(Aggregated_region,Class), fill=Aggregated_region,linetype=Class)) + 
  plot_lay()

p2z_spring <- ggplot(data=spring, aes(x = peak2zero_mean,y=Aggregated_region, group=paste(Aggregated_region,Class), fill=Aggregated_region,linetype=Class)) + 
  plot_lay()

p2z_summer <-ggplot(data=summer, aes(x = peak2zero_mean,y=Aggregated_region, group=paste(Aggregated_region,Class), fill=Aggregated_region,linetype=Class)) + 
  plot_lay()

p2z_fall <- ggplot(data=fall, aes(x = peak2zero_mean,y=Aggregated_region, group=paste(Aggregated_region,Class), fill=Aggregated_region,linetype=Class)) + 
  plot_lay()

p2z_all <- ggplot(data=all_season, aes(x = peak2zero_mean,y=Aggregated_region, group=paste(Aggregated_region,Class), fill=Aggregated_region,linetype=Class)) + 
  geom_density_ridges(scale=2,alpha = .75,panel_scaling = FALSE,rel_min_height=0.01) +
  scale_fill_manual(values = pal_regions)+
  scale_color_manual(values = pal_regions)+
  xlim(0,360) +
...
plot_lay<- function(season){
  list(
    ...
    annotate("text", x = 2, y = y_pos, label = paste0(abbreviate(counts$`paste(Aggregated_region, Class)`,2),' = ',counts$n))
  )}

get_counts<- function(season,metric){
...
counts = get_counts(winter,"drying_rate_mean")
dr_winter = ggplot(data=winter, aes(x = drying_rate_mean,y=Aggregated_region, group=paste(Aggregated_region,Class), fill=Aggregated_region,linetype=Class)) + 
  plot_lay()

counts = get_counts(spring,"drying_rate_mean")
dr_spring <- ggplot(data=spring, aes(x = drying_rate_mean,y=Aggregated_region, group=paste(Aggregated_region,Class), fill=Aggregated_region,linetype=Class)) + 
  plot_lay()

counts = get_counts(summer,"drying_rate_mean")
dr_summer <-ggplot(data=summer, aes(x = drying_rate_mean,y=Aggregated_region, group=paste(Aggregated_region,Class), fill=Aggregated_region,linetype=Class)) + 
  plot_lay()

counts = get_counts(fall,"drying_rate_mean")
dr_fall <- ggplot(data=fall, aes(x = drying_rate_mean,y=Aggregated_region, group=paste(Aggregated_region,Class), fill=Aggregated_region,linetype=Class)) + 
  plot_lay()

counts = get_counts(all_season,"drying_rate_mean")
dr_all <- ggplot(data=all_season, aes(x = drying_rate_mean,y=Aggregated_region, group=paste(Aggregated_region,Class), fill=Aggregated_region,linetype=Class,na.rm=T)) + 
  plot_lay()
