...
de_winter<- ggplot()+
  geom_density(data=winter, aes(x = n_event_mean, group=Aggregated_region,color = Aggregated_region)) +
...
de_spring <- ggplot()+
  geom_density(data=spring, aes(x = n_event_mean, group=Aggregated_region,color = Aggregated_region),alpha=0.2) +
  scale_color_manual(values = pal_regions)+
  theme(
    # get rid of panel grids
    panel.grid.major = element_blank(),
...
de_summer <- ggplot()+
  geom_density(data=summer, aes(x = n_event_mean, group=Aggregated_region,color = Aggregated_region),alpha=0.2) +
  scale_color_manual(values = pal_regions)+
  theme(
    # get rid of panel grids
    panel.grid.major = element_blank(),
